...
\caption[Observer Observable Implementation]{Proposed implementation of the Observer and Observable Design pattern}
...
\caption[Illegal Parameter Error Prompt]{Proposed design for the illegal parameter error message displayed to the user}
\label{fig:error}
\end{figure}
...
\end{equation}
\caption[Probabilistic Function]{Algebraic model of the probabilistic function used to calculate next move for any Agent \cite{probfunc:image}}
\label{fig:probfunc}
\end{figure}
...
\begin{algorithm}[H]
\caption[Probabilistic function Pseudo-code]{Pseudo-code for Probabilistic function - Each Agent - figure~\ref{fig:probfunc}}
